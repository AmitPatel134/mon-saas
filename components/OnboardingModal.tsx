...
const steps = [
  ...
  },
  {
    ...
    description: "Enregistrez vos biens immobiliers : adresse, surface, prix, type… CleoAI s'en charge pour trouver les acheteurs qui correspondent.",
    cta: "Suivant",
